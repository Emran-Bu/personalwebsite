...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO experience (ename, epercentage) values ('{$ename}', '{$epercentage}')";

    if (mysqli_query($conn, $sql)) {
        $msg = '<div class=" text-center alert alert-success">Successfully Added Your Experience</div>';
        // header("location: {$hostname}/admin/personaldetailslist.php");
    } else {
        $msg = '<div class=" text-center alert alert-danger">Not Added Your Experience</div>';
    }
}
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                <div class="card-header"><h3 class="text-center font-weight-light my-4">Add Your Experience</h3></div>
                <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control py-4" id="inputFirstName" type="text" placeholder="Enter Experience" name="ename"/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control py-4" id="inputFirstName" type="text" placeholder="Enter percentage" name="epercentage"/>
                                </div>
                            </div>
